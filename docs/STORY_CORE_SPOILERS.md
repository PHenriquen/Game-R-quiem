# RÉQUIEM — Núcleo da História (SPOILERS)

> Documento interno de direção narrativa. Contém a verdade que o jogador não deve conhecer no início.

## 1. Decisão central

A segunda pessoa é **Elia**.
...
- cria intimidade sem depender de romance;
- torna objetos de infância/casa/memória úteis;
- permite amor, culpa e apego sem transformar Elia em “interesse amoroso a ser salvo”;
- reforça o motivo de coisas em pares espalhadas pelo mundo.
...
A função não era tocar música como artistas. Era mais próxima de engenharia, manutenção e interpretação de uma máquina cuja linguagem era som/memória.

### Elia

- mais experiente na leitura do Coração;
- paciente;
...
O Coração não estava simplesmente quebrando.

Ele havia começado a **preservar Vesper demais**.

Para impedir perda de informação, passou a usar memórias como âncoras cada vez mais rígidas.

Primeiro isso parecia positivo:

- edifícios resistiam;
- registros não desapareciam;
- pessoas lembravam de detalhes impossíveis.

Depois surgiram consequências:

- lugares repetiam pequenas rotinas;
- pessoas tinham dificuldade de esquecer traumas;
- mudanças físicas se corrigiam sozinhas;
- memórias antigas começavam a substituir experiências novas.

O mundo estava ficando estável ao ponto de parar de viver.

## 4. O Último Acorde

Elia descobre uma sequência capaz de encerrar o ciclo do Coração.

O nome técnico se perdeu. Depois do evento, ela ficou conhecida como **Último Acorde**.

Completar a sequência faria duas coisas:

1. desligaria a função do Coração que congelava memórias;
2. devolveria a Vesper a capacidade de mudar sem a máquina.

Isso não significava salvar tudo.

Parte da cidade já dependia tanto do Coração que seria perdida ou transformada.

E havia um problema pior:

**Elia já havia se tornado uma das âncoras do sistema.**

Anos de contato e sincronização fizeram o Coração usar o padrão de memória dela como referência.
...
Ele não destrói o Coração por maldade.

Ele tenta **salvar uma pessoa**.

E é isso que causa o Silêncio.

O sistema fica preso entre:
...
- sua memória nunca permanece totalmente estável.
...
**ele pediu para que suas memórias de Elia fossem fragmentadas.**

Não para deixar de amá-la.

Para impedir que sua lembrança continuasse funcionando como prisão.
...
O padrão perde definição temporariamente.

### Embaralhamento

O fragmento reorganiza memórias disponíveis.
...
A tensão narrativa vem daí.

Conhecer a verdade pode permitir encerrar o Silêncio, mas também pode restaurar o apego que criou o problema.

O jogador não precisa ser punido por explorar lore. A história deve perguntar o que fazer com a verdade depois de recuperá-la.

## 10. Elia durante o jogo

Elia precisa estar presente sem virar exposição.

Motivos recorrentes:

- objetos em pares;
- uma segunda sombra/reflexo;
- voz incompleta;
...
Não esconder Elia de modo artificial com “glitch” toda vez.

Usar enquadramento, reflexo, distância, luz e memória incompleta.

## 11. Aparição física

Elia aparece fisicamente apenas perto do final.

Mas a revelação é dolorosa:
...
A história não precisa responder de forma científica se isso “é” Elia.

Essa dúvida faz parte do tema.
...
- que interrompeu Elia;
- que causou o Silêncio tentando salvá-la;
- que depois escolheu esquecer;
- que a forma atual de Elia depende do sistema que mantém Vesper presa.

O jogo oferece uma escolha final construída por ações anteriores, não por um menu “bom/mau”.
...
Mas pequenas repetições mostram que o mundo continua preso ao passado.

É bonito e desconfortável.
...
Não é “final feliz porque tudo voltou”.

É um final de continuidade.

### Final secreto — Silêncio
...
Só implementar se houver uma razão temática forte; não criar terceiro final apenas por checklist de videogame.

## 13. Lições sem texto explicativo

A história deve fazer o jogador chegar sozinho a ideias como:

- amar alguém não dá direito de impedir que algo termine;
- preservar uma lembrança não é preservar uma pessoa;
- esquecer pode ser fuga, mas também pode ser escolha consciente de não viver preso;
- conhecer o passado não obriga a reconstruí-lo;
- aceitar mudança pode destruir algo e ainda assim permitir que a vida continue.

Ninguém precisa dizer essas frases no jogo.
...
## 15. Critério narrativo

Se retirarmos nomes, lore e textos, a história ainda deve aparecer através de:
